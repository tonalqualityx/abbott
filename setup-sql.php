...
$sql .= "CREATE TABLE IF NOT EXISTS " . $table_prefix . "customers (customer_id INT NOT NULL AUTO_INCREMENT PRIMARY KEY, first_name VARCHAR(45), last_name VARCHAR(45), mailing_st VARCHAR(255), mailing_st2 VARCHAR(255), mailing_city VARCHAR(45), mailing_zip VARCHAR(5));";
$sql .= "CREATE TABLE IF NOT EXISTS " . $table_prefix . "phone_numbers (phone_id INT NOT NULL AUTO_INCREMENT PRIMARY KEY, phone VARCHAR(12), phone_type VARCHAR(45), customer_id INT, FOREIGN KEY (customer_id) REFERENCES " . $table_prefix . "customers(customer_id));";
...
$sql .= "CREATE TABLE IF NOT EXISTS " . $table_prefix . "service_locations (location_id INT NOT NULL AUTO_INCREMENT PRIMARY KEY, location_st VARCHAR(255), location_st2 VARCHAR(255), location_city VARCHAR(255), location_zip VARCHAR(5));";
